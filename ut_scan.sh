...
EOF
  ...
  echo "执行pnpm vitest@latest"
  pnpm_add -D vitest@latest @vitest/coverage-v8@latest @vitejs/plugin-vue@latest @vitejs/plugin-vue-jsx@latest jsdom@24.0.0 semver@7.5.1 --quiet
